...
　This is the damage value to the opponent's unit calculated after various calculations.

OT_DCLevel : Apply level correction to final damage
OT_DCTolerance: add error to final damage

If both corrections are enabled, the correction processing order is level difference correction → damage error.
